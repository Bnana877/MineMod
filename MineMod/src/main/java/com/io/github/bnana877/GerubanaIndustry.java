...
@Mod(GerubanaIndustry.MODID)
public final class GerubanaIndustry {
    ...
    public GerubanaIndustry(FMLJavaModLoadingContext context) {
        ...
        BuildCreativeModeTabContentsEvent.BUS.addListener(GerubanaIndustry::addCreative);
